...
socket.on('message', function (msg) {
   ...
   /* document.querySelector('#weather_wrapper .temp').textContent = data.temp + '°';
    ...
    if (temp < 10) {
        ...
        tempStatus.className = 'badge badge-info'; // Adjust the class as needed
    } else if (temp >= 10 && temp < 17) {
        tempStatus.textContent = 'Cool';
        tempMessage.textContent = 'အေးမြသည်၊၊';
        tempStatus.className = 'badge badge-primary'; // Adjust the class as needed
    } else if (temp >= 17 && temp < 30) {
        tempStatus.textContent = 'Warm';
        tempMessage.textContent = 'နွေးထွေးသည်။';
        tempStatus.className = 'badge badge-warning'; // Adjust the class as needed
    } else if (temp >= 30 && temp < 35) {
        tempStatus.textContent = 'Hot';
        tempMessage.textContent = 'ပူသည်။';
        tempStatus.className = 'badge badge-danger'; // Adjust the class as needed
        ...
        tempStatus.className = 'badge badge-dark'; // Adjust the class as needed
    }
